<?php
        ...
        require ("/xampp/htdocs/TP4795PROJECTINTERFACE/PHP/my_orders.php");
        $packages = getOrders($_SESSION["email"]);
?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex flex-row justify-content-between align-items-center filters">
                        <h6>Showing <?php echo count($packages);?> out of <?php echo count($packages);?> results.</h6>
                    </div>
                </div>
            </div>
                ...
                { ?>
                    <div class="col-md-4">
                        <div class="p-card bg-white p-2 rounded px-1 mt-3 mb-3">
                            ...
                            <div class="d-flex justify-content-center">
                                <p><?php echo $packages[$i]['DateOfOrder'];?></p>
                            </div>
