        ...
        <header class="page-header header container-fluid">
            <div class="description">
                ...
                <div class="form-group">
                        ...
                        <p name="Message2" id="Message2">Empty Name</p>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                        ...
                        <p name="Message4" id="Message4">Empty Subject</p>
                </div>
                <div class="form-group">
                        <textarea class="form-control" rows="4" id="Textarea"></textarea>
                        <p name="Message3" id="Message3">Empty Message</p>  
                </div>
                <input type="button" id= "Register" class="btn btn-secondary btn-block" value="Submit" onclick="Done()">
            </div>
        </header>
                ...
                <div class="container">
                        <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-12">
                                        ...
                                        <p>Leoforos Kalokairinou, TK 71410 Heraklion, Crete, Greece
                                                <br />info@flytime.gr
                                                <br />+30 - 2810 - 379827,
                                                <br />+30 - 2810 - 379332</p>
                                </div>
