    ...
    <header class="page-header header container-fluid">
        <div class="container mt-5 mb-5">
            ...
            <div class="d-flex justify-content-end text-right mt-2">
                <nav>
                    <ul class="pagination">
                        <li class="page-item"><a class="page-link" href="travel_packages_list_page.php" aria-label="Previous"><span
                        ...
                        <li class="page-item"><a class="page-link" href="travel_packages_list_page3.php" aria-label="Next"><span
                                    aria-hidden="true">»</span></a></li>
                    </ul>
                </nav>
            </div>
